...
public class LS_livetvdetsmart{

public static void LS_320x480_1(java.util.LinkedHashMap<String, anywheresoftware.b4a.keywords.LayoutBuilder.ViewWrapperAndAnchor> views, int width, int height, float scale) {
anywheresoftware.b4a.keywords.LayoutBuilder.setScaleRate(0.3);
String _tinggi="";
_tinggi = BA.NumberToString((11d / 100 * height));
views.get("ivepgdet").vw.setHeight((int)(Double.parseDouble(_tinggi)/2.5d));
views.get("ivepgdet").vw.setWidth((int)(Double.parseDouble(_tinggi)/2.5d));
views.get("ivepgdet").vw.setTop((int)((5.5d / 100 * height)));
views.get("ivepgdet").vw.setLeft((int)((98d / 100 * width) - (views.get("ivepgdet").vw.getWidth())));
views.get("ivepgdet2").vw.setHeight((int)(Double.parseDouble(_tinggi)/2.5d));
views.get("ivepgdet2").vw.setWidth((int)(Double.parseDouble(_tinggi)/2.5d));
views.get("ivepgdet2").vw.setTop((int)((0.5d / 100 * height)));
views.get("ivepgdet2").vw.setLeft((int)((views.get("ivepgdet").vw.getLeft() + views.get("ivepgdet").vw.getWidth()) - (views.get("ivepgdet2").vw.getWidth())));
views.get("ivthumdet").vw.setLeft((int)(0d));
views.get("ivthumdet").vw.setWidth((int)(Double.parseDouble(_tinggi)+(Double.parseDouble(_tinggi)/2d) - (0d)));
...
views.get("lblepgdet").vw.setWidth((int)((views.get("ivepgdet").vw.getLeft()) - ((views.get("ivthumdet").vw.getWidth()))));
